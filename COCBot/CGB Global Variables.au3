...
Global $BottomRight[5][2] = [[452, 586], [595, 484], [654, 440], [715, 393], [779, 344]]
...
Global $THSnipeTroopGroup[10][4] = [["Arch",1,1,-1],["Barb",0,1,-1],["Giant",2,5,-1],["Wall",4,2,-1],["Gobl",3,1,-1],["Heal",7,14,-1],["Pekk",9,25,-1],["Ball",5,5,-1],["Wiza",6,4,-1],["Drag",8,20,-1]]
...
Global Const $aLabTroops[25][5] = [ _
		[-1, -1, -1, "없음", $eIcnBlank], _
		[123, 311, 0, "바바리안", $eIcnBarbarian], _
		[123, 417, 0, "아처", $eIcnArcher], _
		[230, 311, 0, "자이언트", $eIcnGiant], _
		[230, 417, 0, "고블린", $eIcnGoblin], _
		[336, 311, 0, "해골돌격병", $eIcnWallBreaker], _
		[336, 417, 0, "해골비행선", $eIcnBalloon], _
		[443, 311, 0, "마법사", $eIcnWizard], _
		[443, 417, 0, "치유사", $eIcnHealer], _
		[550, 311, 0, "드래곤", $eIcnDragon], _
		[550, 417, 0, "페카", $eIcnPekka], _
		[657, 311, 0, "번개마법", $eIcnLightSpell], _
		[657, 417, 0, "회복마법", $eIcnHealSpell], _
		[105, 311, 1, "분노마법", $eIcnRageSpell], _
		[105, 417, 1, "이동마법", $eIcnJumpSpell], _
		[211, 311, 1, "얼음마법", $eIcnFreezeSpell], _
		[211, 417, 1, "독마법", $eIcnHourGlass], _
		[317, 311, 1, "지진마법", $eIcnHourGlass], _
		[317, 417, 1, "신속마법", $eIcnHourGlass], _
		[424, 311, 1, "미니언", $eIcnMinion], _
		[424, 417, 1, "호그라이더", $eIcnHogRider], _
		[531, 311, 1, "발키리", $eIcnValkyrie], _
		[531, 417, 1, "골렘", $eIcnGolem], _
		[637, 311, 1, "마녀", $eIcnWitch], _
		[637, 417, 1, "라바하운드", $eIcnLavaHound]]
...
; SNIPE TH WHILE TRAINING ARMY

Global $iChkSnipeWhileTrain, $isSnipeWhileTrain ,$DidntRevert
Global $tempSnipeWhileTrain[8] = [0,0,0,0,0,0,0,0]
Global $BottomTHType,$LTCount,$num,$numperspot,$spots
Global $aTHInfo[3] = ["", "", ""]
Global $TrainLoopCounter = 0
Global $haltSearch = False