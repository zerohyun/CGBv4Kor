...
Func ProfileReport()
	...
	SetLog("프로필 현황", $COLOR_BLUE)
	SetLog("공격/방어/지원/요청 현황을 파악합니다.", $COLOR_BLUE)
	...
	SetLog(" [ATKW]: " & _NumberFormatLog($AttacksWon) & " [DEFW]: " & _NumberFormatLog($DefensesWon) & " [TDON]: " & _NumberFormatLog($TroopsDonated) & " [TREC]: " & _NumberFormatLog($TroopsReceived), $COLOR_GREEN)
