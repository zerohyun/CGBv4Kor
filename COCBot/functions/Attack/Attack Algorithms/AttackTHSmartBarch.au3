...
Func AttackTHSmartBarch()
		...
		Setlog("'홀치기'!! Smartbarch모드 - 1. 바바리안/아처", $COLOR_BLUE)
		...
		Setlog("'홀치기'!! Smartbarch모드 - 2. 바바리안/아처", $COLOR_BLUE)
...
;end check for one star
		...
		Setlog("'홀치기'!! Smartbarch모드 - 3. 바바리안/자이언트/아처", $COLOR_BLUE)
...
;end check for one star
		...
		Setlog("'홀치기'!! Smartbarch모드 - 4. 모든 유닛", $COLOR_BLUE)
