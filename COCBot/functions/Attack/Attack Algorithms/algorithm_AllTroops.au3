...
;~ 		EndIf
	...
	If ($iChkRedArea[$iMatchMode]) Then
		SetLog("Smart Attack : 전략 계산중....", $COLOR_BLUE)
		Local $hTimer = TimerInit()
		_WinAPI_DeleteObject($hBitmapFirst)
		$hBitmapFirst = _CaptureRegion2()
		_GetRedArea()

		SetLog("계산완료  (in " & Round(TimerDiff($hTimer) / 1000, 2) & " seconds) :")
		...
		If ($iChkSmartAttack[$iMatchMode][0] = 1 Or $iChkSmartAttack[$iMatchMode][1] = 1 Or $iChkSmartAttack[$iMatchMode][2] = 1) Then
			SetLog("자원정제소의 위치를 확인합니다.", $COLOR_BLUE)
			$hTimer = TimerInit()
			Global $PixelMine[0]
			...
			If ($iChkSmartAttack[$iMatchMode][2] = 1) Then
				...
				EndIf
			EndIf
			SetLog("위치확인  (in " & Round(TimerDiff($hTimer) / 1000, 2) & " seconds) :")
			SetLog("[" & UBound($PixelMine) & "] 금광")
			SetLog("[" & UBound($PixelElixir) & "] 엘릭서정제소")
			SetLog("[" & UBound($PixelDarkElixir) & "] 다크엘릭서정제소")
		EndIf
	...
	Switch $iChkDeploySettings[$iMatchMode]
		Case 0 ;Single sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			SetLog("공격방향 : 한 방향", $COLOR_BLUE)
			$nbSides = 1
		Case 1 ;Two sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			SetLog("공격방향 : 두 방향", $COLOR_BLUE)
			$nbSides = 2
		Case 2 ;Three sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			SetLog("공격방향 : 세 방향", $COLOR_BLUE)
			$nbSides = 3
		Case 3 ;Two sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			SetLog("공격방향 : 모든 방향", $COLOR_BLUE)
			$nbSides = 4
		Case 4 ;Four fingers style ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			SetLog("네손가락모드 사용", $COLOR_BLUE)
			$nbSides = 5
	EndSwitch
...
#ce
	...
	SetLog("남은 유닛을 모두 투입합니다.", $COLOR_BLUE)
	For $x = 0 To 1
	...
	If ($checkKPower Or $checkQPower) And $iActivateKQCondition = "Manual" Then
		SetLog($delayActivateKQ / 1000 & "  초 후에 영웅스킬을 사용합니다.", $COLOR_BLUE)
	...
	SetLog("모든 유닛이 전투에 투입되었습니다. 전투를 마칠때까지 대기합니다.")
